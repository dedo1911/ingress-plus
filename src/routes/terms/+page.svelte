...
<div>
  <h1>TERMS OF USE</h1>
  <h3>Last updated August 01, 2023</h3>

  <h3>AGREEMENT TO OUR LEGAL TERMS</h3>

  <p>We are Ingress.Plus ("Company," "we," "us," "our").</p>
  ...
  <p>
    ...
    whether personally or on behalf of an entity ("you"), and Ingress.Plus,
  ...
  <p>
    ...
    request to: <a href="mailto:help@ingress.plus">help@ingress.plus</a>. If we
  ...
  <p>
    ...
    to leave the Services and access the Third-Party Websites or to use or
  ...
  <p>
    ...
    https://ingress.plus/terms. By using the Services, you agree to be bound by
    our Privacy Policy, which is incorporated into these Legal Terms. Please be
    advised the Services are hosted in Italy. If you access the Services from
    ...
    laws in Italy, then through your continued use of the Services, you are
    transferring your data to Italy, and you expressly consent to have your data
    transferred to and processed in Italy.
  </p>
  ...
  <p>
    ...
    Italy, and the use of the United Nations Convention of Contracts for the
    ...
    country to residence. Ingress.Plus and yourself both agree to submit to the
    non-exclusive jurisdiction of the courts of Rome, which means that you may
  ...
  <p>
    ...
    acceptance. The seat of arbitration shall be Rome, Italy. The language of
    the proceedings shall be Italian. Applicable rules of substantive law shall
    be the law of Italy.
  </p>
  ...
  <p>
    Ingress.Plus<br />
    __________<br />
    <a href="mailto:help@ingress.plus">help@ingress.plus</a>
  </p>
</div>
